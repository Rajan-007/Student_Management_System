...
export default function App() {
  ...
  return (
    ...
    <TouchableOpacity className="mx-28 mt-10 " onPress={handlePress}>
    <View >
      <LinearGradient className="
       border-cyan-300 rounded-full border"
    ...
    <View className='flex-1 flex-row justify-center items-end z-[1]'>
